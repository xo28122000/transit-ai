...
class TwentyEightIntentHandler(AbstractRequestHandler):
    # """Handler for twenty eight intent."""
    # def can_handle(self, handler_input):
    #     # type: (HandlerInput) -> bool
    #     return is_intent_name("TwentyEightIntent")(handler_input)
    #
    # def handle(self, handler_input):
    #     # type: (HandlerInput) -> Response
    #     logger.info("In TwentyEightIntentHandler")
    #
    #
    #
    #
    #     timings = util.get_transit_57()
    #
    #
    #
    #
    #     speech = ("twenty eight inbound in {} minutes and {} minutes. outbound in {} minutes and {} minutes ").format(timings[0],timings[1],timings[2],timings[3])
    #
